...
const team: { name: string; nameEn: string; role: RoleKey; photo?: string }[] = [
  { name: "თენგიზ გორდეზიანი", nameEn: "Tengiz Gordeziani", role: "president_board", photo: "https://cpjh7clklgrmjqio.public.blob.vercel-storage.com/team/Tengiz_Gordeziani.png"},
  ...
  { name: "საბა მოდებაძე", nameEn: "Saba Modebadze", role: "secretary_general_board", photo: "https://cpjh7clklgrmjqio.public.blob.vercel-storage.com/team/Saba_Modebadze.jpg" },
  { name: "მარიამ გაგოშაშვილი", nameEn: "Mariam Gagoshashvili", role: "board", photo: "https://cpjh7clklgrmjqio.public.blob.vercel-storage.com/team/Mariam_Gagoshashvili.jpg" },
  { name: "რევაზ თოლორდავა", nameEn: "Revaz Tolordava", role: "board", photo: "https://cpjh7clklgrmjqio.public.blob.vercel-storage.com/team/Revaz_Tolordava.jpg" },
  { name: "ხატია ყველაშვილი", nameEn: "Khatia Kvelashvili", role: "academic_secretary_board", photo: "https://cpjh7clklgrmjqio.public.blob.vercel-storage.com/team/Khatia_Khvelashvili.jpg" },
  { name: "ილია ქავთარაძე", nameEn: "Ilia Kavtaradze", role: "board", photo: "https://cpjh7clklgrmjqio.public.blob.vercel-storage.com/team/Ilia_Kavtaradze.jpg" },
  { name: "ლიკა ცერცვაძე", nameEn: "Lika Tsertsvadze", role: "board", photo: "https://cpjh7clklgrmjqio.public.blob.vercel-storage.com/team/lika_cercvadze.jpg" },
  { name: "გიორგი ბერუჩაშვილი", nameEn: "Giorgi Beruchashvili", role: "scientific", photo: "https://cpjh7clklgrmjqio.public.blob.vercel-storage.com/team/Giorgi_Beruchashvili.jpg" },
  { name: "ლალი გოგინავა", nameEn: "Lali Goginava", role: "scientific", photo: "https://cpjh7clklgrmjqio.public.blob.vercel-storage.com/team/Lali_Goginava.jpg" },
  { name: "სოფიო გორგიჯანიძე", nameEn: "Sopio Gorgijanidze", role: "scientific", photo: "https://cpjh7clklgrmjqio.public.blob.vercel-storage.com/team/Sophio_Gorgijanidze.jpg" },
  { name: "გიორგი დვალაშვილი", nameEn: "Giorgi Dvalashvili", role: "scientific", photo: "https://cpjh7clklgrmjqio.public.blob.vercel-storage.com/team/Giorgi_Dvalashvili.jpg" },
  { name: "ნოდარ ელიზბარაშვილი", nameEn: "Nodar Elizbarashvili", role: "scientific", photo: "https://cpjh7clklgrmjqio.public.blob.vercel-storage.com/team/Nodar_Elizbarashvili.jpg" },
  { name: "თეონა თიგიშვილი", nameEn: "Teona Tigishvili", role: "scientific", photo: "https://cpjh7clklgrmjqio.public.blob.vercel-storage.com/team/Teona_Tigishvili.jpg" },
  ...
  { name: "დემეტრე მოდებაძე", nameEn: "Demetre Modebadze", role: "scientific", photo: "https://cpjh7clklgrmjqio.public.blob.vercel-storage.com/team/Demetre_Modebadze.png"},
  ...
  { name: "ვანო ცარციძე", nameEn: "Vano Tsartsidze", role: "scientific", photo: "https://cpjh7clklgrmjqio.public.blob.vercel-storage.com/team/Vano_Tsartsidze.jpg" },
  { name: "ნოდარ ხორბალაძე", nameEn: "Nodar Khorbaladze", role: "scientific", photo: "https://cpjh7clklgrmjqio.public.blob.vercel-storage.com/team/Nodar_Khorbaladze.jpg" },
  ...
  { name: "ვლადიმერ ბუაჩიძე", nameEn: "Vladimer Buachidze", role: "scientific", photo: "https://cpjh7clklgrmjqio.public.blob.vercel-storage.com/team/Vladimer_Buachidze.jpg" },
  { name: "გიორგი გაფრინდაშვილი", nameEn: "Giorgi Gaprindashvili", role: "scientific", photo: "https://cpjh7clklgrmjqio.public.blob.vercel-storage.com/team/Giorgi_Gaprindashvili.jpg" },
];
